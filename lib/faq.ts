/**
 * Shared by the FAQ section and the FAQPage JSON-LD, so the rendered answers and
 * the structured data can never disagree.
 * Every answer is sourced from the positioning brief — nothing invented.
 */
export const FAQS: { q: string; a: string }[] = [
  {
    q: "What is Topri?",
    a: "Topri is a team of three AI employees built for real estate investors and wholesalers. Andy is an outbound acquisitions caller who works your seller lead list and qualifies prospects. Randy is an inbound receptionist who answers every call 24/7. Alyssa handles back-office follow-up and operations. You can hire one or all three.",
  },
  {
    q: "How fast can I go live?",
    a: "Under six days. Day one is a scoping call where we map your lead sources, CRM, calendar and how you qualify a deal. Days two and three are build and training. Days four and five are test calls you listen to and approve. Day six you go live.",
  },
  {
    q: "How is this different from hiring a cold caller or a VA?",
    a: "A human caller covers about 40 hours a week and handles outbound only. The Topri team covers 168 hours a week across outbound, inbound and follow-up, for roughly what one caller costs you today. Every seller gets the same qualification on the first call and the thousandth.",
  },
  {
    q: "What does Topri cost?",
  ...
  {
    q: "Will a real lead get called before I approve anything?",
    a: "No. On days four and five you hear the agents live on test calls and approve them before a single real lead is dialed.",
  },
  {
    q: "Does Topri work with my CRM?",
    a: "Andy pushes clean data into your CRM automatically, and Alyssa keeps it organized. We map your specific CRM, lead sources and calendar during the day-one scoping call.",
  },
  {
  ...
  },
  {
    ...
    a: "An AI acquisitions caller is a phone agent that dials seller leads, holds a real conversation, qualifies each prospect against your criteria, and books the qualified ones into your calendar — without a human on the line. Topri's is Andy: he works your lead list on the five pillars (motivation, urgency, condition, price, reason for selling), handles objections in the moment, and pushes clean call data into your CRM.",
  },
  {
    q: "How much does an AI cold caller for real estate cost?",
    a: "Topri's outbound caller Andy runs $1,600–$2,500 a month depending on call volume and script complexity. For comparison, a human cold caller typically costs $1,500–$5,000+ a month for 40 hours a week of outbound only. The full Topri team — outbound, inbound and follow-up — is a flat $5,200 a month.",
  },
  {
    q: "Can Topri work my old or dead seller leads?",
  ...
  {
    q: "Do I need to change my CRM or tools to use Topri?",
    a: "No. Topri is built around the software you already run — your CRM, calendar, dialer and data tools, whether that's Podio, REsimpli, InvestorFuse, GoHighLevel, Follow Up Boss or something unusual. On the day-one scoping call we map your exact stack and configure the agents around it. Nothing to rip out, nothing to migrate.",
  },
];
