...
export const AGENTS: Agent[] = [
  ...
  },
  {
    ...
    page: {
      ...
      callout: {
        ...
        title: "Your business closes at 5. Sellers don’t.",
        body: "A human caller covers 40 of the week’s 168 hours. The other 128 — evenings, weekends, holidays — every call rolls to voicemail, and a motivated seller doesn’t leave a message and wait. They dial the next investor on the list. Nobody staffs those hours at any salary, which is why the after-hours gap isn’t a staffing problem to solve. It’s a coverage problem, and coverage is exactly what Randy is.",
        points: [
          "128 hours a week your current setup leaves uncovered",
          "The 9pm seller gets a conversation, not a beep",
          "Same five-pillar qualification at 2am as at 2pm",
          "You wake up to captured details and booked appointments, not voicemails to return",
        ],
      },
  ...
  },
  {
    ...
    page: {
      ...
      callout: {
        eyebrow: "Follow-up debt",
        title: "The most expensive leads you own are the warm ones going cold.",
        body: "Every qualified seller who never got a second touch is money you already spent — on the list, on the call, on the qualification — quietly expiring in your CRM. Most operations run follow-up out of the owner’s memory, which means it happens on the good weeks and slips on the busy ones. And the busy weeks are exactly when the pipeline is fullest. Alyssa runs the sequences whether or not you had a busy week.",
        points: [
          "Email and SMS sequences fire on schedule, not when someone remembers",
          "A seller who said “call me in March” gets called in March",
          "The owner stops being the follow-up system — that’s the most expensive labour in the business",
          "Andy and Randy’s qualified sellers actually get worked afterwards",
        ],
      },
